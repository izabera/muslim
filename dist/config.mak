#
# muslim config.mak template (original in dist/config.mak)
#
...
# Installation prefix for muslim-gcc compiler wrapper.
exec_prefix = /usr/local

# Location for the dynamic linker ld-muslim-$(ARCH).so.1
syslibdir = /lib

# Uncomment if you want to build i386 muslim on a 64-bit host
#CFLAGS += -m32
